...
from LA_MIMO.system import MIMO_1D_System
from Channel.mimo import MIMO_Channel
np.random.seed(10)

def get_args():
    parser = argparse.ArgumentParser(description="MIMO 1D Antenna ISAC system configuration")
...
def run_montecarlo_mimo(Parameters, n_trials):
    ...
    for i in range(n_trials):
        try:
            ...
            system = MIMO_1D_System(**mimo_parameters)
            _, crb = system.run()
